...
let bookName = "  Lập trình FE với JavaScript  "; // Tác giả
let authorName = "Nguyễn Văn Nam"; // Tên tác giả
let publish = 2020; // Năm xuất bản
let price = 100000; // Gía của 1 cuốn sách
...
console.log("Tên sách sau khi chuẩn hóa: ", bookName.trim().toUpperCase());

// - Tên tác giả: Chuyển thành chữ in hoa.
console.log("Tên tác giả sau khi chuẩn hóa: ", authorName.toUpperCase());
...
console.log("3 kí tự đầu của tên tác giả: ", authorName.slice(0, 3));
...
// Tính toán số liệu:
// - Tuổi của sách: Tính xem sách đã xuất bản được bao nhiêu năm
